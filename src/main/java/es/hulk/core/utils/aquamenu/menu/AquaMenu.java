...
import es.hulk.core.utils.task.TaskUtil;
...
public abstract class AquaMenu {
    ...
    public Core plugin = Core.getInstance();
    ...
    public void update(Player player) {
        ...
        if (currentlyOpenedMenu != null && CC.translate(currentlyOpenedMenu.getName(player)).equals(player.getOpenInventory().getTitle()) && current.getSize() == this.getInventorySize(this.slots)) {
            inventory = current;
            passed = true;
        }
