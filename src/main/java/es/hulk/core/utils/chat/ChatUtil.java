package es.hulk.core.utils.chat;
...
public class ChatUtil {
    ...
    public String translate(Player player, Player target, String text, boolean colorized) {
        return ChatUtil.placeholder(player, text, Core.getInstance().isPlaceholderAPI(), colorized);
    }
